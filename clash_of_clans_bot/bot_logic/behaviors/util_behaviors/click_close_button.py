...
def ClickCloseButtonUntilNotFoundBehavior(controller):
    return (
        Repeat(
            Selector([
                # Try all close button images, some work in many cases
                Action(controller.ui.click_button, "images/buttons/common/close_1_shop.png"),
                Action(controller.ui.click_button, "images/buttons/common/close_2_profile.png"),
                Action(controller.ui.click_button, "images/buttons/common/shield_close.png")
            ]),
